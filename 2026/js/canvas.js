...
function getFontSize() {
    ...
    return 2 < t ? .14 * e : 1.75 < t && t < 2.01 ? .14 * e : 1.5 < t && t < 1.76 ? .12 * e : 1.25 < t && t < 1.51 ? .11 * e : 1 < t && t < 1.26 ? .105 * e : .9 < t && t < 1.01 ? .095 * e : .7 < t && t < .91 ? .085 * e : .6 < t && t < .71 ? .08 * e : .5 < t && t < .61 ? .075 * e : .45 < t && t < .51 ? .07 * e : .4 < t && t < .46 ? .065 * e : .35 < t && t < .41 ? .06 * e : .3 < t && t < .36 ? .055 * e : .25 < t && t < .31 ? .05 * e : .2 < t && t < .26 ? .045 * e : .1 < t && t < .11 ? .032 * e : .03 * e
}
